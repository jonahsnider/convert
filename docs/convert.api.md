...
export type _UnitsByMeasureRaw = {
    0: 'radian' | 'radians' | 'rad' | 'rads' | 'r' | 'turn' | 'turns' | 'degree' | 'degrees' | 'deg' | 'degs' | '°' | 'gradian' | 'gradians' | 'gon' | 'gons' | 'grad' | 'grads' | 'grade' | 'grades' | 'arcminute' | 'arcminutes' | 'arcmin' | 'arcmins' | 'arcsecond' | 'arcseconds' | 'arcsec' | 'arcsecs';
