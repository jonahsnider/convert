...
export type _UnitsByMeasureRaw = {
    ...
    6: 'lux' | 'lx' | 'petalux' | 'Plx' | 'teralux' | 'Tlx' | 'gigalux' | 'Glx' | 'megalux' | 'Mlx' | 'kilolux' | 'klx' | 'hectolux' | 'hlx' | 'decalux' | 'dalx' | 'decilux' | 'dlx' | 'centilux' | 'clx' | 'millilux' | 'mlx' | 'microlux' | 'μlx' | 'µlx' | 'nanolux' | 'nlx' | 'picolux' | 'plx' | 'femtolux' | 'flx' | 'lumen per square meter' | 'lm/m2' | 'lm/m²' | 'foot-candle' | 'foot candle' | 'fc' | 'ft-c' | 'phot' | 'ph';
